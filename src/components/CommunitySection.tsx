    ...
    <section className="py-20 md:py-32" style={{
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="space-y-8">
          ...
          <button className="bg-white hover:bg-gray-50 border-2 border-transparent hover:border-purple-200 px-10 py-5 rounded-full text-xl font-['Syne'] transition-all shadow-lg hover:shadow-xl bg-gradient-to-r from-[#B33DEB] to-[#DE8FFF] bg-clip-text text-transparent">
            View Questions
          </button>
        </div>
